...
def get_dataset():
    ...
    data_path = './data'
    pickle.dump(train, open(os.path.join(data_path, 'o_train.pkl'), 'wb'))
    pickle.dump(dev, open(os.path.join(data_path, 'o_dev.pkl'), 'wb'))
    pickle.dump(test, open(os.path.join(data_path, 'o_test.pkl'), 'wb'))
